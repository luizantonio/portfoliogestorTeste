			...
			<div class="container-fluid">
				...
				@elseif (Auth::user()->isMembroAltaDir(Auth::user()->id) )
					<ul class="nav navbar-nav">
						...
						<li class="menu-item dropdown">
                            <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-stats" style="color: red" > Email</span><b class="caret"></b></a>
                            <ul class="dropdown-menu">
								<li class="menu-item dropdown">
                                    <a href="{{ route('relatorio.email')  }}"><span class="glyphicon glyphicon-check" style="color: red"> Meus Emails</span></a>                                    		
                                </li>																
                            </ul>
