                  ...
                  <!-- Add Task Button -->
					<div class="form-group">
						<div class="col-sm-offset-5 col-sm-6">
							...
							<button type="submite" class="btn btn-primary" title="@php echo utf8_encode('Cadastrar dados do usuário');@endphp">
								<i class="fa fa-plus"> Cadastrar</i> 
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" id="btn-cancelar" class="btn btn-warning" title="@php echo utf8_encode('Cancelar operação');@endphp">
