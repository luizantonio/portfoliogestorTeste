...
class RelatorioComtroller extends Controller
{
	...
	public function email(Request $request){	
		...
		//var_dump($result);
		//echo '<p style="color:red;">Relatório Controller</p>';
	...
	*/
	...
	{	
		...
		/*
		*O projeto foi aprovado pela alta direção. Os investimentos empregados no desenvolvimento tornam seu valor agregado relevante.
		*
		*
		*/
		$fases = Fase::all();
