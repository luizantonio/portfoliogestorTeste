				  ...
				  <div class="form-group">			
					@if(!is_null($projeto->isQualIndicador( $projeto->id)) )
							...
							<div class="form-group navbar-form">
								...
								<output><b>@php echo utf8_encode('Valores dos Indiccadores do Projeto:'); @endphp</b></output>								
								@php
									$contadorIndicador = 0;
									$contadorValor = 0;
...
*/
             ...
             @else
                    ...
                    <div class="alert-warning">
                        ...
                        <b> N&atilde;o existem projetos com indicadores informados&#33;</b></span></center>
                    </div>
            @endif
		</div>
	</div>
